...
module TestActsAsTableless
  ...
  module ClassMethods
    def test_acts_as_tableless(target_class)
      ...
      cattr_accessor :test_acts_as_tableless_class
      self.test_acts_as_tableless_class = target_class
    end
  end
  
  module InstanceMethods
    def test_acts_as_tableless_should_have_attributes_corresponding_to_columns
      obj = self.test_acts_as_tableless_class.new
    ...
    def test_acts_as_tableless_should_make_new_object_on_create
      assert_kind_of self.test_acts_as_tableless_class, self.test_acts_as_tableless_class.create
    end
    ...
    def test_acts_as_tableless_should_not_raise_error_on_save
      self.test_acts_as_tableless_class.new.save
    end
  end
end

Test::Unit::TestCase.class_eval { include TestActsAsTableless }